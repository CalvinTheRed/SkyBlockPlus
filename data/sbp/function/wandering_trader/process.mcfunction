...
execute if score #random constant matches 96..99 run data modify entity @s Offers.Recipes append value {maxUses:1,sell:{count:1,id:"minecraft:enchanted_golden_apple"},buy:{count:1,id:"minecraft:golden_apple"},buyB:{count:24,id:"minecraft:diamond"}}
